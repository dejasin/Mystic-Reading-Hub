...
const PROJECT_NAME = "The Oracle";

const PRODUCT_IDENTIFIER = "oracle_full_reading";
const PLAY_STORE_PRODUCT_IDENTIFIER = "oracle_full_reading:full-reading";
...
const PLAY_STORE_APP_NAME = "The Oracle Android";
const PLAY_STORE_PACKAGE_NAME = "com.theoracle.app.android";

const ENTITLEMENT_IDENTIFIER = "full_reading";
const ENTITLEMENT_DISPLAY_NAME = "Full Reading Access";
