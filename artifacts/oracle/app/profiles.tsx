...
const modalStyles = StyleSheet.create({
  ...
  title: { fontFamily: "CinzelDecorative_400Regular", fontSize: 14, color: Colors.cream, letterSpacing: 0.5 },
  ...
  saveBtnText: { fontFamily: "CinzelDecorative_400Regular", fontSize: 13, color: Colors.bg, letterSpacing: 0.5 },
});
...
const styles = StyleSheet.create({
  ...
  synastryBtnTitle: { fontFamily: "CinzelDecorative_400Regular", fontSize: 13, color: Colors.gold, letterSpacing: 0.5 },
  ...
  avatarInitials: { fontFamily: "CinzelDecorative_400Regular", fontSize: 16, color: Colors.gold },
  ...
  photoCountNum: { fontFamily: "CinzelDecorative_400Regular", fontSize: 14, color: Colors.gold },
  ...
  emptyTitle: { fontFamily: "CinzelDecorative_400Regular", fontSize: 16, color: Colors.cream, textAlign: "center" },
