...
import { Hand, Eye, Moon, Sparkles, Star, Camera, ChevronRight, Fingerprint } from 'lucide-react';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const elapsed = (Date.now() - start) % TOTAL_DURATION;
      setTime(elapsed);
        ...
        <AnimatePresence>
          {scene === 3 && (
            ...
            >
              ...
              <motion.button
                className="relative px-10 py-4 bg-surface border border-gold/50 rounded-full overflow-hidden group"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                  ...
                  return (
                    <motion.div
                      ...
                      transition={{ 
                        ...
                        damping: 20, 
                        stiffness: 100, 
                        delay: 0.5 + (arr.length - 1 - idx) * 0.2 
                      }}
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted mt-1">
                            {card.active ? 'Tap to scan' : 'Pending...'}
                          </p>
                        </div>
                      </div>
                      {card.active && (
